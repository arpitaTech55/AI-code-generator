...
function Home() {
  ...
  async function getResponse() {
    ...
    try {
     ...
     You create modern, animated, and fully responsive UI components. You are highly skilled in HTML, CSS, Tailwind CSS, 
     Bootstrap, JavaScript, React, Next.js, Vue.js, Angular, and more.
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-6 lg:px-16">
        {/* Left Section */}
        <div className=" w-full py-6 ml-6 rounded-xl bg-[#141319] mt-5 p-5 ">
          ...
          <div className="flex items-center justify-between m-5">
            ...
            <button
              onClick={getResponse}
              className="inline-flex items-center text-white py-2 px-8 rounded bg-gradient-to-r from-purple-400 to-purple-600 px-5 gap-2 transition-all hover:opacity-80 hover:scale-105 active:scale-95"
            >
          ...
          {!outputScreen ? (
            ...
            <>
              ...
              <div className="bg-[#17171C] w-full h-[50px] flex items-center gap-3 px-3">
                <button
                  onClick={() => setTab(1)}
                  className={`w-1/2 h-[40px] py-4 rounded-lg transition-all ${
                    tab === 1
